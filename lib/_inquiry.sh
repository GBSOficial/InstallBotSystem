...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao GBSOficial selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar BotSystem\n"
  printf "   [1] Atualizar BotSystem\n"
  printf "   [2] Deletar BotSystem\n"
  printf "   [3] Bloquear BotSystem\n"
  printf "   [4] Desbloquear BotSystem\n"
  printf "   [5] Alter. dominio BotSystem\n"
  printf "\n"
  read -p "> " option
